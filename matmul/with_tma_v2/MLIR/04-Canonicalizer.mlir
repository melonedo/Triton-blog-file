...
// IR Dump After Canonicalizer ('tt.func' operation: @triton.language.standard.cdiv__i32__(1,)cconstexpr_64_)
...
module {
  ...
  tt.func private @"triton.language.standard.cdiv__i32__(1,)cconstexpr_64_"(%arg0: i32 loc("/home/ubuntu/triton/python/triton/language/standard.py":31:0)) -> i32 attributes {noinline = false} {
    ...
    %0 = arith.addi %arg0, %c63_i32 : i32 loc(#loc26)
    %1 = arith.divsi %0, %c64_i32 : i32 loc(#loc27)
    tt.return %1 : i32 loc(#loc28)
  } loc(#loc24)
} loc(#loc)
