...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32, "ttg.total-num-warps" = 4 : i32} {
  ...
  ^bb2:  // pred: ^bb1
    ...
    %59 = ttg.local_alloc %58 : (tensor<64x64xf32, #blocked1>) -> !ttg.memdesc<64x64xf32, #shared2, #smem> loc(#loc15)
  ...
  ^bb5:  // 2 preds: ^bb3, ^bb4
    ...
    %76 = ttg.local_alloc %result_0 : (tensor<128x64xf32, #blocked>) -> !ttg.memdesc<128x64xf32, #shared, #smem, mutable> loc(#loc17)
