...
#loc24 = loc("/home/ubuntu/triton/python/triton/language/standard.py":31:0)
module {
  ...
  tt.func private @"triton.language.standard.zeros____(0, 0)cconstexpr_128__(0, 1)cconstexpr_64__(1,)cconstexpr_fp32_"() -> tensor<128x64xf32> attributes {noinline = false} {
    %cst = arith.constant dense<0.000000e+00> : tensor<128x64xf32> loc(#loc22)
    tt.return %cst : tensor<128x64xf32> loc(#loc23)
  } loc(#loc21)
  tt.func private @"triton.language.standard.cdiv__i32__(1,)cconstexpr_64_"(%arg0: i32 loc("/home/ubuntu/triton/python/triton/language/standard.py":31:0)) -> i32 attributes {noinline = false} {
    ...
    %c64_i32_0 = arith.constant 64 : i32 loc(#loc25)
    %0 = arith.extsi %arg0 : i32 to i64 loc(#loc25)
    %1 = arith.extsi %c64_i32_0 : i32 to i64 loc(#loc25)
    %2 = arith.addi %0, %1 : i64 loc(#loc25)
    ...
    %6 = arith.addi %arg0, %c64_i32_0 : i32 loc(#loc25)
    %c1_i32 = arith.constant 1 : i32 loc(#loc26)
    %c1_i32_1 = arith.constant 1 : i32 loc(#loc26)
    %7 = arith.extsi %6 : i32 to i64 loc(#loc26)
    %8 = arith.extsi %c1_i32_1 : i32 to i64 loc(#loc26)
    %9 = arith.subi %7, %8 : i64 loc(#loc26)
    %c2147483647_i64_2 = arith.constant 2147483647 : i64 loc(#loc26)
    %c-2147483648_i64_3 = arith.constant -2147483648 : i64 loc(#loc26)
    %10 = arith.cmpi sle, %9, %c2147483647_i64_2 : i64 loc(#loc26)
    %11 = arith.cmpi sge, %9, %c-2147483648_i64_3 : i64 loc(#loc26)
    %12 = arith.andi %10, %11 : i1 loc(#loc26)
    %13 = arith.subi %6, %c1_i32_1 : i32 loc(#loc26)
    %c64_i32_4 = arith.constant 64 : i32 loc(#loc27)
    %c64_i32_5 = arith.constant 64 : i32 loc(#loc27)
    %14 = arith.divsi %13, %c64_i32_5 : i32 loc(#loc27)
    tt.return %14 : i32 loc(#loc28)
  ^bb1:  // no predecessors
    %15 = ub.poison : i32 loc(#loc29)
    tt.return %15 : i32 loc(#loc29)
  } loc(#loc24)
} loc(#loc)
...
#loc25 = loc("/home/ubuntu/triton/python/triton/language/standard.py":40:16)
#loc26 = loc("/home/ubuntu/triton/python/triton/language/standard.py":40:22)
#loc27 = loc("/home/ubuntu/triton/python/triton/language/standard.py":40:28)
#loc28 = loc("/home/ubuntu/triton/python/triton/language/standard.py":40:11)
#loc29 = loc("/home/ubuntu/triton/python/triton/language/standard.py":40:4)
