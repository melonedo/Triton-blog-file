...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.shared = 180272 : i32, ttg.target = "cuda:100", ttg.tensor_memory_size = 64 : i32, "ttg.threads-per-warp" = 32 : i32, "ttg.total-num-warps" = 4 : i32} {
  tt.func public @matmul_kernel_make_tensor_desciptor(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg2: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg3: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg4: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg5: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0)) attributes {noinline = false} {
    ...
    %result = ttng.tmem_alloc {tensor_memory_col_offset = 0 : i32, tensor_memory_row_offset = 0 : i32} : () -> !ttg.memdesc<128x64xf32, #tmem, #ttng.tensor_memory, mutable> loc(#loc12)
    ...
    %20 = ttg.local_alloc {allocation.offset = 0 : i32} : () -> !ttg.memdesc<3x128x64xf32, #shared, #smem, mutable> loc(#loc14)
    %21 = ttg.local_alloc {allocation.offset = 98304 : i32} : () -> !ttg.memdesc<3x64x64xf32, #shared, #smem, mutable> loc(#loc15)
    %22 = ttg.local_alloc {allocation.offset = 180224 : i32} : () -> !ttg.memdesc<3xi64, #shared1, #smem, mutable> loc(#loc13)
    ...
    %34 = ttg.local_alloc %33 {allocation.offset = 147456 : i32} : (tensor<64x64xf32, #blocked1>) -> !ttg.memdesc<64x64xf32, #shared2, #smem> loc(#loc15)
    ...
    cf.br ^bb1(%c0_i32, %c0_i32, %c1_i32, %c2_i32, %c0_i32, %c0_i32, %18, %c0_i32, %27, %34 : i32, i32, i32, i32, i32, i32, !ttg.memdesc<1xi64, #shared1, #smem, mutable, 2>, i32, !ttg.memdesc<128x64xf32, #shared, #smem, mutable, 3x128x64>, !ttg.memdesc<64x64xf32, #shared2, #smem>) loc(#loc13)
  ^bb1(%38: i32 loc("/home/ubuntu/triton/matmul.py":37:19), %39: i32 loc(unknown), %40: i32 loc(unknown), %41: i32 loc(unknown), %42: i32 loc(unknown), %43: i32 loc(unknown), %44: !ttg.memdesc<1xi64, #shared1, #smem, mutable, 2> loc("/home/ubuntu/triton/matmul.py":37:19), %45: i32 loc(unknown), %46: !ttg.memdesc<128x64xf32, #shared, #smem, mutable, 3x128x64> loc("/home/ubuntu/triton/matmul.py":38:24), %47: !ttg.memdesc<64x64xf32, #shared2, #smem> loc("/home/ubuntu/triton/matmul.py":39:24)):  // 2 preds: ^bb0, ^bb2
    %48 = arith.cmpi slt, %38, %37 : i32 loc(#loc13)
    cf.cond_br %48, ^bb2, ^bb3 loc(#loc13)
  ^bb2:  // pred: ^bb1
    %49 = arith.subi %14, %c3_i32 : i32 loc(#loc13)
    %50 = arith.cmpi slt, %38, %49 : i32 loc(#loc13)
    %51 = arith.addi %42, %c1_i32 : i32 loc(#loc13)
    %52 = arith.cmpi sge, %51, %c3_i32 : i32 loc(#loc13)
    %53 = arith.select %52, %c0_i32, %51 : i32 loc(#loc13)
    %54 = arith.xori %43, %c1_i32 : i32 loc(#loc13)
    %55 = arith.select %52, %54, %43 : i32 loc(#loc13)
    %56 = ttg.memdesc_subview %22[%53] : !ttg.memdesc<3xi64, #shared1, #smem, mutable> -> !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3> loc(#loc13)
    ttng.wait_barrier %56, %55, %true : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3> loc(#loc13)
    %57 = ttg.memdesc_subview %21[%53, %c0_i32, %c0_i32] : !ttg.memdesc<3x64x64xf32, #shared, #smem, mutable> -> !ttg.memdesc<64x64xf32, #shared, #smem, mutable, 3x64x64> loc(#loc15)
    %58 = ttg.local_load %57 : !ttg.memdesc<64x64xf32, #shared, #smem, mutable, 3x64x64> -> tensor<64x64xf32, #blocked1> loc(#loc15)
    ...
    %60 = ttg.memdesc_subview %20[%53, %c0_i32, %c0_i32] : !ttg.memdesc<3x128x64xf32, #shared, #smem, mutable> -> !ttg.memdesc<128x64xf32, #shared, #smem, mutable, 3x128x64> loc(#loc14)
    %61 = ttg.memdesc_subview %17[%40] : !ttg.memdesc<2xi64, #shared1, #smem, mutable> -> !ttg.memdesc<1xi64, #shared1, #smem, mutable, 2> loc(#loc13)
    ttng.fence_async_shared {bCluster = false} loc(#loc12)
    ttng.tc_gen5_mma %60, %59, %result, %true, %true, %61[%true] : !ttg.memdesc<128x64xf32, #shared, #smem, mutable, 3x128x64>, !ttg.memdesc<64x64xf32, #shared2, #smem>, !ttg.memdesc<128x64xf32, #tmem, #ttng.tensor_memory, mutable>, !ttg.memdesc<1xi64, #shared1, #smem, mutable, 2> loc(#loc12)
    ttng.wait_barrier %44, %45 deps %46, %47 : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 2>, !ttg.memdesc<128x64xf32, #shared, #smem, mutable, 3x128x64>, !ttg.memdesc<64x64xf32, #shared2, #smem> loc(#loc12)
    %62 = arith.xori %39, %c1_i32 : i32 loc(#loc12)
    %63 = arith.addi %40, %c1_i32 : i32 loc(#loc12)
    %64 = arith.cmpi sge, %63, %c2_i32 : i32 loc(#loc12)
    %65 = arith.select %64, %c0_i32, %63 : i32 loc(#loc12)
    %66 = arith.select %64, %62, %39 : i32 loc(#loc12)
    %67 = arith.addi %41, %c1_i32 : i32 loc(#loc13)
    %68 = arith.cmpi sge, %67, %c3_i32 : i32 loc(#loc13)
    %69 = arith.select %68, %c0_i32, %67 : i32 loc(#loc13)
    %70 = arith.addi %38, %c3_i32 : i32 loc(#loc13)
    %71 = arith.muli %70, %c64_i32 : i32 loc(#loc16)
    %72 = ttg.memdesc_subview %22[%69] : !ttg.memdesc<3xi64, #shared1, #smem, mutable> -> !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3> loc(#loc13)
    ttng.barrier_expect %72, 49152, %50 : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3> loc(#loc13)
    %73 = ttg.memdesc_subview %20[%69, %c0_i32, %c0_i32] : !ttg.memdesc<3x128x64xf32, #shared, #smem, mutable> -> !ttg.memdesc<128x64xf32, #shared, #smem, mutable, 3x128x64> loc(#loc14)
    ttng.async_tma_copy_global_to_local %5[%15, %71] %73, %72, %50 : !tt.tensordesc<tensor<128x64xf32, #shared>>, !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3> -> !ttg.memdesc<128x64xf32, #shared, #smem, mutable, 3x128x64> loc(#loc14)
    %74 = ttg.memdesc_subview %21[%69, %c0_i32, %c0_i32] : !ttg.memdesc<3x64x64xf32, #shared, #smem, mutable> -> !ttg.memdesc<64x64xf32, #shared, #smem, mutable, 3x64x64> loc(#loc15)
    ttng.async_tma_copy_global_to_local %9[%71, %16] %74, %72, %50 : !tt.tensordesc<tensor<64x64xf32, #shared>>, !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3> -> !ttg.memdesc<64x64xf32, #shared, #smem, mutable, 3x64x64> loc(#loc15)
    %75 = arith.addi %38, %c1_i32 : i32 loc(#loc13)
    cf.br ^bb1(%75, %66, %65, %69, %53, %55, %61, %39, %60, %59 : i32, i32, i32, i32, i32, i32, !ttg.memdesc<1xi64, #shared1, #smem, mutable, 2>, i32, !ttg.memdesc<128x64xf32, #shared, #smem, mutable, 3x128x64>, !ttg.memdesc<64x64xf32, #shared2, #smem>) loc(#loc13)
  ^bb3:  // pred: ^bb1
    cf.cond_br %26, ^bb4, ^bb5 loc(#loc13)
  ^bb4:  // pred: ^bb3
    ttng.wait_barrier %44, %45 deps %46, %47 : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 2>, !ttg.memdesc<128x64xf32, #shared, #smem, mutable, 3x128x64>, !ttg.memdesc<64x64xf32, #shared2, #smem> loc(#loc12)
    cf.br ^bb5 loc(#loc13)
  ^bb5:  // 2 preds: ^bb3, ^bb4
    ...
    %76 = ttg.local_alloc %result_0 {allocation.offset = 0 : i32} : (tensor<128x64xf32, #blocked>) -> !ttg.memdesc<128x64xf32, #shared, #smem, mutable> loc(#loc17)
    ttng.fence_async_shared {bCluster = false} loc(#loc17)
    ttng.async_tma_copy_local_to_global %12[%15, %16] %76 : !tt.tensordesc<tensor<128x64xf32, #shared>>, !ttg.memdesc<128x64xf32, #shared, #smem, mutable> loc(#loc17)
