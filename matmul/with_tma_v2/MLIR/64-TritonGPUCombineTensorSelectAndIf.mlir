...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @matmul_kernel_make_tensor_desciptor(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg2: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg3: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg4: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg5: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0)) attributes {noinline = false} {
    ...
    %38:9 = scf.for %arg6 = %c0_i32 to %37 step %c1_i32 iter_args(%arg7 = %c0_i32, %arg8 = %c1_i32, %arg9 = %c2_i32, %arg10 = %c0_i32, %arg11 = %c0_i32, %arg12 = %18, %arg13 = %c0_i32, %arg14 = %27, %arg15 = %34) -> (i32, i32, i32, i32, i32, !ttg.memdesc<1xi64, #shared1, #smem, mutable, 2>, i32, !ttg.memdesc<128x64xf32, #shared, #smem, mutable, 3x128x64>, !ttg.memdesc<64x64xf32, #shared2, #smem>)  : i32 {
      %40 = arith.subi %14, %c3_i32 : i32 loc(#loc13)
      %41 = arith.cmpi slt, %arg6, %40 : i32 loc(#loc13)
      %42 = arith.addi %arg10, %c1_i32 : i32 loc(#loc13)
      %43 = arith.cmpi sge, %42, %c3_i32 : i32 loc(#loc13)
      %44 = arith.select %43, %c0_i32, %42 : i32 loc(#loc13)
      %45 = arith.xori %arg11, %c1_i32 : i32 loc(#loc13)
      %46 = arith.select %43, %45, %arg11 : i32 loc(#loc13)
      %47 = ttg.memdesc_subview %22[%44] : !ttg.memdesc<3xi64, #shared1, #smem, mutable> -> !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3> loc(#loc13)
      ttng.wait_barrier %47, %46, %true : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3> loc(#loc13)
      %48 = ttg.memdesc_subview %21[%44, %c0_i32, %c0_i32] : !ttg.memdesc<3x64x64xf32, #shared, #smem, mutable> -> !ttg.memdesc<64x64xf32, #shared, #smem, mutable, 3x64x64> loc(#loc15)
      %49 = ttg.local_load %48 : !ttg.memdesc<64x64xf32, #shared, #smem, mutable, 3x64x64> -> tensor<64x64xf32, #blocked1> loc(#loc15)
      %50 = ttg.local_alloc %49 : (tensor<64x64xf32, #blocked1>) -> !ttg.memdesc<64x64xf32, #shared2, #smem> loc(#loc15)
      %51 = ttg.memdesc_subview %20[%44, %c0_i32, %c0_i32] : !ttg.memdesc<3x128x64xf32, #shared, #smem, mutable> -> !ttg.memdesc<128x64xf32, #shared, #smem, mutable, 3x128x64> loc(#loc14)
      %52 = ttg.memdesc_subview %17[%arg8] : !ttg.memdesc<2xi64, #shared1, #smem, mutable> -> !ttg.memdesc<1xi64, #shared1, #smem, mutable, 2> loc(#loc13)
      ttng.fence_async_shared {bCluster = false} loc(#loc12)
      ttng.tc_gen5_mma %51, %50, %result, %true, %true, %52[%true] : !ttg.memdesc<128x64xf32, #shared, #smem, mutable, 3x128x64>, !ttg.memdesc<64x64xf32, #shared2, #smem>, !ttg.memdesc<128x64xf32, #tmem, #ttng.tensor_memory, mutable>, !ttg.memdesc<1xi64, #shared1, #smem, mutable, 2> loc(#loc12)
      ...
      %53 = arith.xori %arg7, %c1_i32 : i32 loc(#loc12)
      %54 = arith.addi %arg8, %c1_i32 : i32 loc(#loc12)
      %55 = arith.cmpi sge, %54, %c2_i32 : i32 loc(#loc12)
      %56 = arith.select %55, %c0_i32, %54 : i32 loc(#loc12)
      %57 = arith.select %55, %53, %arg7 : i32 loc(#loc12)
      %58 = arith.addi %arg9, %c1_i32 : i32 loc(#loc13)
      %59 = arith.cmpi sge, %58, %c3_i32 : i32 loc(#loc13)
      %60 = arith.select %59, %c0_i32, %58 : i32 loc(#loc13)
      %61 = arith.addi %arg6, %c3_i32 : i32 loc(#loc13)
      %62 = arith.muli %61, %c64_i32 : i32 loc(#loc16)
      %63 = ttg.memdesc_subview %22[%60] : !ttg.memdesc<3xi64, #shared1, #smem, mutable> -> !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3> loc(#loc13)
      ttng.barrier_expect %63, 49152, %41 : !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3> loc(#loc13)
      %64 = ttg.memdesc_subview %20[%60, %c0_i32, %c0_i32] : !ttg.memdesc<3x128x64xf32, #shared, #smem, mutable> -> !ttg.memdesc<128x64xf32, #shared, #smem, mutable, 3x128x64> loc(#loc14)
      ttng.async_tma_copy_global_to_local %5[%15, %62] %64, %63, %41 : !tt.tensordesc<tensor<128x64xf32, #shared>>, !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3> -> !ttg.memdesc<128x64xf32, #shared, #smem, mutable, 3x128x64> loc(#loc14)
      %65 = ttg.memdesc_subview %21[%60, %c0_i32, %c0_i32] : !ttg.memdesc<3x64x64xf32, #shared, #smem, mutable> -> !ttg.memdesc<64x64xf32, #shared, #smem, mutable, 3x64x64> loc(#loc15)
      ttng.async_tma_copy_global_to_local %9[%62, %16] %65, %63, %41 : !tt.tensordesc<tensor<64x64xf32, #shared>>, !ttg.memdesc<1xi64, #shared1, #smem, mutable, 3> -> !ttg.memdesc<64x64xf32, #shared, #smem, mutable, 3x64x64> loc(#loc15)
      scf.yield %57, %56, %60, %44, %46, %52, %arg7, %51, %50 : i32, i32, i32, i32, i32, !ttg.memdesc<1xi64, #shared1, #smem, mutable, 2>, i32, !ttg.memdesc<128x64xf32, #shared, #smem, mutable, 3x128x64>, !ttg.memdesc<64x64xf32, #shared2, #smem> loc(#loc13)
    } loc(#loc13)
    scf.if %26 {
    ...
    %39 = ttg.local_alloc %result_0 : (tensor<128x64xf32, #blocked>) -> !ttg.memdesc<128x64xf32, #shared, #smem, mutable> loc(#loc17)
    ttng.fence_async_shared {bCluster = false} loc(#loc17)
    ttng.async_tma_copy_local_to_global %12[%15, %16] %39 : !tt.tensordesc<tensor<128x64xf32, #shared>>, !ttg.memdesc<128x64xf32, #shared, #smem, mutable> loc(#loc17)
