...
module {
  tt.func public @matmul_kernel_make_tensor_desciptor(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg2: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg3: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg4: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg5: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0)) attributes {noinline = false} {
    ...
    %9 = scf.for %arg6 = %c0_i32 to %8 step %c1_i32 iter_args(%arg7 = %cst) -> (tensor<128x64xf32>)  : i32 {
      ...
      %14 = tt.descriptor_load %3[%12, %13] : !tt.tensordesc<tensor<128x64xf32>> -> tensor<128x64xf32> loc(#loc13)
      %15 = arith.muli %1, %c64_i32 : i32 loc(#loc14)
      %16 = tt.descriptor_load %5[%13, %15] : !tt.tensordesc<tensor<64x64xf32>> -> tensor<64x64xf32> loc(#loc15)
      %17 = tt.dot %14, %16, %arg7, inputPrecision = tf32 : tensor<128x64xf32> * tensor<64x64xf32> -> tensor<128x64xf32> loc(#loc16)
      scf.yield %17 : tensor<128x64xf32> loc(#loc17)
    } loc(#loc10)
    %10 = arith.muli %0, %c128_i32 : i32 loc(#loc18)
    %11 = arith.muli %1, %c64_i32 : i32 loc(#loc19)
    tt.descriptor_store %6[%10, %11], %9 : !tt.tensordesc<tensor<128x64xf32>>, tensor<128x64xf32> loc(#loc20)
    tt.return loc(#loc21)
  } loc(#loc)
} loc(#loc)
#loc1 = loc(unknown)
