...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @matmul_kernel_make_tensor_desciptor(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg2: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg3: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg4: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg5: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0)) attributes {noinline = false} {
    ...
    %11 = scf.for %arg6 = %c0_i32 to %8 step %c1_i32 iter_args(%arg7 = %cst) -> (tensor<128x64xf32, #blocked>)  : i32 {
      %15 = arith.muli %arg6, %c64_i32 : i32 loc(#loc13)
      %16 = tt.descriptor_load %3[%9, %15] : !tt.tensordesc<tensor<128x64xf32, #shared>> -> tensor<128x64xf32, #blocked1> loc(#loc14)
      %17 = ttg.local_alloc %16 : (tensor<128x64xf32, #blocked1>) -> !ttg.memdesc<128x64xf32, #shared, #smem> loc(#loc14)
      %18 = tt.descriptor_load %5[%15, %10] : !tt.tensordesc<tensor<64x64xf32, #shared>> -> tensor<64x64xf32, #blocked1> loc(#loc15)
      ...
      %20 = ttng.tc_gen5_mma %17, %19, %result[%token], %true, %true : !ttg.memdesc<128x64xf32, #shared, #smem>, !ttg.memdesc<64x64xf32, #shared1, #smem>, !ttg.memdesc<128x64xf32, #tmem, #ttng.tensor_memory, mutable> loc(#loc16)
    ...
    %12 = ttg.convert_layout %11 : tensor<128x64xf32, #blocked> -> tensor<128x64xf32, #blocked1> loc(#loc12)
    %13 = arith.muli %0, %c128_i32 : i32 loc(#loc18)
    %14 = arith.muli %1, %c64_i32 : i32 loc(#loc19)
    tt.descriptor_store %6[%13, %14], %12 : !tt.tensordesc<tensor<128x64xf32, #shared>>, tensor<128x64xf32, #blocked1> loc(#loc20)
    tt.return loc(#loc21)
  } loc(#loc)
} loc(#loc)
#loc1 = loc(unknown)
...
#loc13 = loc("/home/ubuntu/triton/matmul.py":38:51)
