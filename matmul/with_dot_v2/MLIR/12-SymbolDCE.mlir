...
module {
  tt.func public @matrix_multiplication_kernel(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg2: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg3: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg4: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg5: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg6: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg7: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg8: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0)) attributes {noinline = false} {
    ...
    %16 = tt.broadcast %14 : tensor<128x1x!tt.ptr<f32>> -> tensor<128x64x!tt.ptr<f32>> loc(#loc14)
    %17 = tt.broadcast %15 : tensor<1x64xi32> -> tensor<128x64xi32> loc(#loc14)
    %18 = tt.addptr %16, %17 : tensor<128x64x!tt.ptr<f32>>, tensor<128x64xi32> loc(#loc14)
    ...
    %22 = tt.splat %arg1 : !tt.ptr<f32> -> tensor<64x1x!tt.ptr<f32>> loc(#loc17)
    %23 = tt.addptr %22, %21 : tensor<64x1x!tt.ptr<f32>>, tensor<64x1xi32> loc(#loc17)
    %24 = tt.expand_dims %9 {axis = 0 : i32} : tensor<64xi32> -> tensor<1x64xi32> loc(#loc18)
    %25 = tt.broadcast %23 : tensor<64x1x!tt.ptr<f32>> -> tensor<64x64x!tt.ptr<f32>> loc(#loc19)
    %26 = tt.broadcast %24 : tensor<1x64xi32> -> tensor<64x64xi32> loc(#loc19)
    %27 = tt.addptr %25, %26 : tensor<64x64x!tt.ptr<f32>>, tensor<64x64xi32> loc(#loc19)
    %28 = arith.addi %arg4, %c63_i32 : i32 loc(#loc43)
    %29 = arith.divsi %28, %c64_i32 : i32 loc(#loc44)
    %30 = scf.for %arg9 = %c0_i32 to %29 step %c1_i32 iter_args(%arg10 = %cst_0) -> (tensor<128x64xf32>)  : i32 {
      %45 = arith.muli %arg9, %c64_i32 : i32 loc(#loc24)
      %46 = arith.subi %arg4, %45 : i32 loc(#loc25)
      ...
      %50 = tt.addptr %18, %49 : tensor<128x64x!tt.ptr<f32>>, tensor<128x64xi32> loc(#loc27)
      %51 = tt.broadcast %48 : tensor<1x64xi1> -> tensor<128x64xi1> loc(#loc28)
      %52 = tt.load %50, %51, %cst_0 : tensor<128x64x!tt.ptr<f32>> loc(#loc28)
      ...
      %57 = tt.addptr %27, %56 : tensor<64x64x!tt.ptr<f32>>, tensor<64x64xi32> loc(#loc31)
      %58 = tt.broadcast %54 : tensor<64x1xi1> -> tensor<64x64xi1> loc(#loc32)
      %59 = tt.load %57, %58, %cst : tensor<64x64x!tt.ptr<f32>> loc(#loc32)
      %60 = tt.dot %52, %59, %arg10, inputPrecision = tf32 : tensor<128x64xf32> * tensor<64x64xf32> -> tensor<128x64xf32> loc(#loc33)
    ...
    %40 = tt.splat %arg5 : i32 -> tensor<1x64xi32> loc(#loc39)
