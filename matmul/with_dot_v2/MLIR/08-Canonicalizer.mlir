...
module {
  tt.func public @matrix_multiplication_kernel(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg2: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg3: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg4: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg5: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg6: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg7: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg8: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0)) attributes {noinline = false} {
    ...
    %29 = arith.addi %arg4, %c63_i32 : i32 loc(#loc59)
    ...
    %31 = scf.for %arg9 = %c0_i32 to %30 step %c1_i32 iter_args(%arg10 = %cst_0) -> (tensor<128x64xf32>)  : i32 {
      ...
      %59 = arith.subi %arg4, %58 : i32 loc(#loc26)
      ...
      %65 = tt.addptr %19, %64 : tensor<128x64x!tt.ptr<f32>>, tensor<128x64xi32> loc(#loc30)
      %66 = tt.broadcast %62 : tensor<1x64xi1> -> tensor<128x64xi1> loc(#loc31)
      %67 = tt.load %65, %66, %cst_0 : tensor<128x64x!tt.ptr<f32>> loc(#loc31)
      ...
      %74 = tt.addptr %28, %73 : tensor<64x64x!tt.ptr<f32>>, tensor<64x64xi32> loc(#loc36)
      %75 = tt.broadcast %70 : tensor<64x1xi1> -> tensor<64x64xi1> loc(#loc37)
      %76 = tt.load %74, %75, %cst : tensor<64x64x!tt.ptr<f32>> loc(#loc37)
    ...
    %53 = tt.splat %arg5 : i32 -> tensor<1x64xi32> loc(#loc55)
...
#loc38 = loc("/home/ubuntu/triton/matmul.py":38:33)
#loc39 = loc("/home/ubuntu/triton/matmul.py":38:23)
#loc40 = loc("/home/ubuntu/triton/matmul.py":38:8)
#loc41 = loc("/home/ubuntu/triton/matmul.py":41:28)
#loc42 = loc("/home/ubuntu/triton/matmul.py":41:39)
#loc43 = loc("/home/ubuntu/triton/matmul.py":41:21)
#loc44 = loc("/home/ubuntu/triton/matmul.py":41:58)
#loc45 = loc("/home/ubuntu/triton/matmul.py":41:51)
#loc46 = loc("/home/ubuntu/triton/matmul.py":42:22)
#loc47 = loc("/home/ubuntu/triton/matmul.py":42:50)
#loc48 = loc("/home/ubuntu/triton/matmul.py":42:37)
#loc49 = loc("/home/ubuntu/triton/matmul.py":43:22)
#loc50 = loc("/home/ubuntu/triton/matmul.py":43:50)
#loc51 = loc("/home/ubuntu/triton/matmul.py":43:37)
#loc52 = loc("/home/ubuntu/triton/matmul.py":44:22)
#loc53 = loc("/home/ubuntu/triton/matmul.py":44:33)
#loc54 = loc("/home/ubuntu/triton/matmul.py":44:47)
#loc55 = loc("/home/ubuntu/triton/matmul.py":44:58)
#loc56 = loc("/home/ubuntu/triton/matmul.py":44:39)
#loc57 = loc("/home/ubuntu/triton/matmul.py":45:21)
#loc58 = loc("/home/ubuntu/triton/matmul.py":45:4)
