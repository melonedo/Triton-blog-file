...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @matrix_multiplication_kernel(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg2: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg3: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg4: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg5: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg6: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg7: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg8: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0)) attributes {noinline = false} {
    ...
    %32:2 = scf.for %arg9 = %c0_i32 to %30 step %c1_i32 iter_args(%arg10 = %false, %arg11 = %31) -> (i1, !ttg.async.token)  : i32 {
      ...
      %55 = tt.load %53, %54, %cst_0 : tensor<128x64x!tt.ptr<f32>, #blocked> loc(#loc29)
      ...
      %63 = tt.load %61, %62, %cst : tensor<64x64x!tt.ptr<f32>, #blocked> loc(#loc33)
    ...
    %33 = tt.splat %arg8 : i32 -> tensor<128x1xi32, #blocked> loc(#loc35)
    %34 = arith.muli %10, %33 : tensor<128x1xi32, #blocked> loc(#loc35)
    %35 = tt.splat %arg2 : !tt.ptr<f32> -> tensor<128x1x!tt.ptr<f32>, #blocked> loc(#loc36)
    %36 = tt.addptr %35, %34 : tensor<128x1x!tt.ptr<f32>, #blocked>, tensor<128x1xi32, #blocked> loc(#loc36)
    %37 = tt.broadcast %36 : tensor<128x1x!tt.ptr<f32>, #blocked> -> tensor<128x64x!tt.ptr<f32>, #blocked> loc(#loc37)
    %38 = tt.broadcast %25 : tensor<1x64xi32, #blocked> -> tensor<128x64xi32, #blocked> loc(#loc37)
    %39 = tt.addptr %37, %38 : tensor<128x64x!tt.ptr<f32>, #blocked>, tensor<128x64xi32, #blocked> loc(#loc37)
    %40 = tt.splat %arg3 : i32 -> tensor<128x1xi32, #blocked> loc(#loc38)
    %41 = arith.cmpi slt, %10, %40 : tensor<128x1xi32, #blocked> loc(#loc38)
    %42 = tt.splat %arg5 : i32 -> tensor<1x64xi32, #blocked> loc(#loc39)
    %43 = arith.cmpi slt, %25, %42 : tensor<1x64xi32, #blocked> loc(#loc39)
    %44 = tt.broadcast %41 : tensor<128x1xi1, #blocked> -> tensor<128x64xi1, #blocked> loc(#loc40)
    %45 = tt.broadcast %43 : tensor<1x64xi1, #blocked> -> tensor<128x64xi1, #blocked> loc(#loc40)
    %46 = arith.andi %44, %45 : tensor<128x64xi1, #blocked> loc(#loc40)
    %47 = ttg.convert_layout %result_2 : tensor<128x64xf32, #blocked1> -> tensor<128x64xf32, #blocked> loc(#loc41)
    tt.store %39, %47, %46 : tensor<128x64x!tt.ptr<f32>, #blocked> loc(#loc41)
    tt.return loc(#loc42)
  } loc(#loc)
} loc(#loc)
#loc1 = loc(unknown)
