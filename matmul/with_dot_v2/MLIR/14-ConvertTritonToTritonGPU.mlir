// Next run Pass --tritongpu-coalesce
// IR Dump After ConvertTritonToTritonGPU ('builtin.module' operation)
// Current Run Pass --convert-triton-to-tritongpu
...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @matrix_multiplication_kernel(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg2: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg3: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg4: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg5: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg6: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg7: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0), %arg8: i32 {tt.divisibility = 16 : i32} loc("/home/ubuntu/triton/matmul.py":6:0)) attributes {noinline = false} {
    ...
    %40 = scf.for %arg9 = %c0_i32 to %39 step %c1_i32 iter_args(%arg10 = %cst_0) -> (tensor<128x64xf32, #blocked>)  : i32 {
      ...
      %58 = arith.subi %arg4, %57 : i32 loc(#loc25)
      ...
      %62 = tt.addptr %23, %61 : tensor<128x64x!tt.ptr<f32>, #blocked>, tensor<128x64xi32, #blocked> loc(#loc27)
      %63 = tt.broadcast %60 : tensor<1x64xi1, #blocked> -> tensor<128x64xi1, #blocked> loc(#loc28)
      %64 = tt.load %62, %63, %cst_0 : tensor<128x64x!tt.ptr<f32>, #blocked> loc(#loc28)
      ...
      %69 = tt.addptr %37, %68 : tensor<64x64x!tt.ptr<f32>, #blocked>, tensor<64x64xi32, #blocked> loc(#loc31)
      ...
      %72 = tt.load %69, %71, %cst : tensor<64x64x!tt.ptr<f32>, #blocked> loc(#loc32)
      %73 = ttg.convert_layout %64 : tensor<128x64xf32, #blocked> -> tensor<128x64xf32, #ttg.dot_op<{opIdx = 0, parent = #blocked5}>> loc(#loc28)
      %74 = ttg.convert_layout %72 : tensor<64x64xf32, #blocked> -> tensor<64x64xf32, #ttg.dot_op<{opIdx = 1, parent = #blocked5}>> loc(#loc32)
      %75 = ttg.convert_layout %arg10 : tensor<128x64xf32, #blocked> -> tensor<128x64xf32, #blocked5> loc(#loc33)
      %76 = tt.dot %73, %74, %75, inputPrecision = tf32 : tensor<128x64xf32, #ttg.dot_op<{opIdx = 0, parent = #blocked5}>> * tensor<64x64xf32, #ttg.dot_op<{opIdx = 1, parent = #blocked5}>> -> tensor<128x64xf32, #blocked5> loc(#loc34)
